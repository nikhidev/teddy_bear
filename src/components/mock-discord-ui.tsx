...
export const MockDiscourdUi = ({ children }: PropsWithChildren) => {
  return (
    <div className="flex min-h-[800px] w-full bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
      ...
      <div className="hidden sm:flex w-[72px] bg-[#202225] py-3 flex-col items-center">
        ...
        {[...Array(5)].map((_, i) => (
          <div
            key={i}
            className="size-12 bg-discord-background rounded-3xl flex  justify-center items-center mb-3 hover:rounded-xl transition-all duration-200 hover:bg-discord-brand-color cursor-not-allowed"
          >
      ...
      <div className="p-2 bg-[#292b2f] flex items-center">
        <div className="h-8 w-8 rounded-full bg-brand-700 mr-2" />
        <div className="flex-1">
          <p className="text-sm font-medium text-white">You</p>
          <p className="text-xs font-medium flex items-center">@your_account</p>
        </div>
  ...
  {/** message history */}
  <div className="flex-1 overflow-y-auto p-4 bg-discord-background flex flex-col-reverse">{children}
  </div>
  {/** message input */}
  <div className="p-4">

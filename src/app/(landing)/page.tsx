...
import { MaxWidthWrapped } from "@/components/max-width-wrapped"
import { Check, Star } from "lucide-react"
import { SignButton } from "@/components/signButton"
import { MockDiscourdUi } from "@/components/mock-discord-ui"
import { AnimatedList } from "@/components/ui/animation_list"
  ...
  return (
    <>
      <section className="relative py-24 sm:py-32 bg-brand-25">
        <MaxWidthWrapped className="text-center">
      ...
      <section className="relative bg-brand-25 pb-4">
        ...
        <div className="relative mx-auto">
          <MaxWidthWrapped className="relative">
      ...
      <section className="relative py-24 sm:py-32 bg-brand-25">
        <MaxWidthWrapped className="flex flex-col items-center gap-16 sm:gap-20">
          <div>
